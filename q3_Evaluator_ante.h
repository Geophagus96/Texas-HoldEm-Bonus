...
array<double,3> Expectation_3(int X1, int X2, int X3, int X4, int X5, int X6, int X7, int Y1, int simulation_times_3, int cards[52]){
    int temp_cards[52];
    for (int i=0; i<52; i++){
        temp_cards[i] = cards[i];
    }
    int cards_unknown[44];
    int cards_known[8] = {X1,X2,X3,X4,X5,X6,X7,Y1};
    for (int i=0; i<8; i++){
            int n = (52-i);
            int x = cards_known[i];
    ...
    for (int j=0; j<44; j++){
        ...
        int player_rank = SevenEval::GetRank(X1, X2, X3, X4, X5, X6, X7);
        int dealer_rank = SevenEval::GetRank(X3, X4, X5, X6, X7, cards_unknown[j], Y1);
...
array<double,4> Expectation_2(int X1, int X2, int X3, int X4, int X5, int X7, int Y1, int simulation_times_3, int cards[52]){
    int temp_cards_2[52];
    for (int i=0; i<52; i++){
        temp_cards_2[i] = cards[i];
    }
    int cards_2_known[7] = {X1,X2,X3,X4,X5,X7,Y1};
    for (int i=0; i<7; i++){
        int n = (52-i);
    ...
    for (int i=0; i<45; i++){
       ...
       array <double,3> prob_win_3 = Expectation_3(X1,X2,X3,X4,X5,X6,X7,Y1,simulation_times_3,cards);
    ...
    expectation_2 = expectation_2/45;
    prob_win_21 = prob_win_21/45;
    prob_win_22 = prob_win_22/45;
    prob_lose_23 = prob_lose_23/45;
...
array<double,2>  Expectation_1(int X1, int X2, int X7, int Y1, int simulation_times_1, int simulation_times_2, int cards[52]){
    int temp_cards_1[52];
    for (int i=0; i<52; i++){
        temp_cards_1[i] = cards[i];
    }
    int cards_1_known[4] = {X1,X2,X7,Y1};
    int cards_1_unknown[48];
    for (int i=0; i<4; i++){
        int n = (52-i);
    ...
    for (int j=0; j<simulation_times_1;j++){
            for (int i=0; i<3; i++){
                ...
                cards_1_unknown[ridx] = cards_1_unknown[(48-i-1)];
                cards_1_unknown[(48-i-1)] = temp;
            }
            array <double,4> decision= Expectation_2(X1, X2, cards_1_unknown[45], cards_1_unknown[46], cards_1_unknown[47],X7,Y1,simulation_times_2, cards);
